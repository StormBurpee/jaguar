...
(function() {
  ...
  exports.som = (ref = Array.prototype.some) != null ? ref : function(fn) {
    var e, i, len1, ref1;
    ref1 = this;
  ...
  exports.baseFileName = function(file, stripExt = false, useWinPathSep = false) {
    ...
    parts = file.split('.');
    parts.pop();
    if (parts[parts.length - 1] === 'jaguar' && parts.length > 1) {
      parts.pop();
    }
    return parts.join('.');
  };

  exports.isJaguar = function(file) {
    return /\.((lit)?jaguar|jaguar\.md)$/.test(file);
  };
